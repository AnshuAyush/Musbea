...
public class createYourAccount extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Floating heart
        LottieAnimationView neon_heart = findViewById(R.id.neon_heart);
        LottieAnimationView floating_heart = findViewById(R.id.floating_heart);
        floating_heart.setVisibility(View.GONE);
        neon_heart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                floating_heart.setVisibility(View.VISIBLE);
                floating_heart.playAnimation();
            }
        });
